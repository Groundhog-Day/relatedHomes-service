...
const writeFile = fs.createWriteStream('./images.csv')
...
COPY images(image_id, image_url, showrank, home_id)
FROM '/Users/robertlopez/Desktop/relatedHomes-service/images.csv' DELIMITER ',' CSV HEADER;
*/

/*
Insert into CASSANDRA with the following
COPY relatedhomes.images_by_home (id, image_url, showrank, home_id)
FROM '/Users/robertlopez/Desktop/relatedHomes-service/images.csv' WITH HEADERS = TRUE;
*/